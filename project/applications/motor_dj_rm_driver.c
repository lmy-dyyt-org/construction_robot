...
static void set_motor_passive_feedback(void)
{
    ...
    APID_Set_Out_Limit(motor_get_pid_pos(M2006_1_CAN1), 100);
    ...
    APID_Set_Out_Limit(motor_get_pid_pos(M2006_2_CAN1), 100);
    ...
    APID_Set_Out_Limit(motor_get_pid_pos(M2006_3_CAN1), 100);
    ...
    APID_Set_Out_Limit(motor_get_pid_pos(M2006_4_CAN1), 100);
